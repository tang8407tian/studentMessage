            ...
            <form method="post" action="${pageContext.request.contextPath}/AddServlet">
              <fieldset><legend>&nbsp;基本信息&nbsp;</legend>
                <p><label for="id" class="left">ID</label>
                   <input type="text" name="id" id="id" class="field" value="" tabindex="1" />
                 
                		<!-- 登录错误信息显示 -->
                <samp style="color: red ;margin-left: 20px">${erroMessage}</samp>
                ...
                <p><label for="birthday" class="left">出生年月</label>
                   ...
                   <input type="text" name="avgscore" id="avgscore" class="field" value="" tabindex="1" />
                                   <samp style="color: red ;margin-left: 20px">${erroMessage}</samp>
